...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RawHTMLContentBlock'
        db.create_table('easy_pages_rawhtmlcontentblock', (
            ('contentblock_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['easy_pages.ContentBlock'], unique=True, primary_key=True)),
            ('content', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('easy_pages', ['RawHTMLContentBlock'])

        # Adding model 'RestrictedHTMLContentBlock'
        db.create_table('easy_pages_restrictedhtmlcontentblock', (
            ('contentblock_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['easy_pages.ContentBlock'], unique=True, primary_key=True)),
            ('content', self.gf('html_field.db.models.fields.HTMLField')(blank=True)),
        ))
        db.send_create_signal('easy_pages', ['RestrictedHTMLContentBlock'])


    def backwards(self, orm):
        
        # Deleting model 'RawHTMLContentBlock'
        db.delete_table('easy_pages_rawhtmlcontentblock')

        # Deleting model 'RestrictedHTMLContentBlock'
        db.delete_table('easy_pages_restrictedhtmlcontentblock')
