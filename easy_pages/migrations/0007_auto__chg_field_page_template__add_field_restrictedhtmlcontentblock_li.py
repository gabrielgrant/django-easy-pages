...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('easy_pages_page', 'template', self.gf('django.db.models.fields.FilePathField')(path='/home/gabriel/repos/alton-mill-top/alton-mill/alton_mill/settings/../templates/easy_pages', max_length=200, match='.*\\.html$'))
        # Adding field 'RestrictedHTMLContentBlock.link_url'
        db.add_column('easy_pages_restrictedhtmlcontentblock', 'link_url',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'RestrictedHTMLContentBlock.link_url'
        db.delete_column('easy_pages_restrictedhtmlcontentblock', 'link_url')
    ...
    models = {
        ...
        'easy_pages.page': {
            ...
            'template': ('django.db.models.fields.FilePathField', [], {'default': "''", 'path': "'/home/gabriel/repos/alton-mill-top/alton-mill/alton_mill/settings/../templates/easy_pages'", 'max_length': '200', 'match': "'.*\\\\.html$'", 'blank': 'True'}),
