...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Page.template'
        db.alter_column('easy_pages_page', 'template', self.gf('django.db.models.fields.FilePathField')(path='/home/gabriel/Documents/alton mill/site2/alton_mill/settings/../templates/easy_pages', max_length=100, match='.*\\.html$'))
    ...
    models = {
        ...
        'easy_pages.page': {
            ...
            'template': ('django.db.models.fields.FilePathField', [], {'default': "''", 'path': "'/home/gabriel/Documents/alton mill/site2/alton_mill/settings/../templates/easy_pages'", 'max_length': '200', 'match': "'.*\\\\.html$'", 'blank': 'True'}),
